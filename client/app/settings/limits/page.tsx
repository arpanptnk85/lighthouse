...
export default function SettingsLimitsPage() {
  ...
  return (
    <SettingsLayout breadcrumbs={breadcrumbs} componentType="security">
      <div className="space-y-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl">
            Monitor your organization's resource consumption. Limits are based
            on your current tier and reset at the start of every billing cycle.
          </p>
        </div>
